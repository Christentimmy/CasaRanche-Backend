...
<head>
  ...
  <title>CasaRancha - Verification Code</title>
  <style>
...
<body>
  <div class="container">
    <div class="email-wrapper">
      <!-- Header -->
      <div class="header">
        <div class="brand-name">CasaRancha</div>
      ...
      <div class="content">
        ...
        <div class="security-notice">
          <h3>Security Tip</h3>
          <p>
            Never share this code with anyone. Our CasaRancha representatives will never ask for your verification code.
      ...
      <div class="footer">
        ...
        <p>Need help? <a href="#" class="support-link">Contact CasaRancha Support</a></p>
        <p class="copyright">&copy; 2024 CasaRancha. All rights reserved.</p>
      </div>
    </div>
  </div>
</body>
